...
\jnote{This doesn't seem to work super-well with the random oracle model.} 
\tsnote{Why not?  As we discussed on the phone, this should be fine.  In the ROM, if we ever need to simulate $\Hash$, we just do it by lazy sampling.}
