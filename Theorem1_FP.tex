...
The PRF game of $F$ is shown in \Cref{fig:prf}. Let prf-adversaries
$B_1, B_2$ be as shown in \Cref{fig:BGame1}. \tsnote{Why is $B_2$
  ...
  of~$\rho_2$.  Also, please use the macro for Func.}  By
