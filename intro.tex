...
on what it learns from the set-membership oracle is the key
definitional distribution of~NY.
...
set come from? Is it random? Adversarially chosen?} Then the
...
false positive. \jnote{We discussed this on the phone, but let me
...
security is defined without regard for efficiency}; the surrounding
...
algorithms. \jnote{Perhaps it is reasonable to consider a definition
...
``dynamic'' case, in contrast to the ``static'' case.}, in the sense
