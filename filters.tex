...
\heading{Privacy of hash-based filters.} \tsnote{This is wide open.  Privacy of~$S$?  Privacy of~$M$?  (The latter may or may not imply the former, depending on how we define things.)  }
...
\caption{Set-privacy for an $(n,k,m)$-filter~$B$ for private (top) and public (bottom) hash functions. \textcolor{cyan}{Revisit when the FP notion settles out.}}
\label{fig:fp-filter}
\end{figure}