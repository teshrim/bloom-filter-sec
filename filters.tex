...
$(i,x) \getsr A^{\QryOracle,\CorruptOracle}(S_1,S_2,\ldots,S_\ell)$\\
...
\nudge $M_i \gets \Rep_i^{\HashOracle}(S_i)$\\
$(i,x) \getsr A^{\QryOracle,\HashOracle,\CorruptOracle}(S_1,S_2,\ldots,S_\ell)$\\
if $i \not\in \mathcal{C} \wedge \Qry_i^{\HashOracle}(M_i,x)=1$ then \\
\nudge Ret 1\\ 
Ret 0
}
...
\nudge $ \mathcal{H}_i \gets \{h^i_1,h^i_2,\ldots,h^i_k\} \getsr \Hash_i$\\
\nudge $M_i \gets \Rep_i^{\HashOracle}(S_i)$\\
$(i,x) \getsr A^{\QryOracle,\CorruptOracle}(S_1,S_2,\ldots,S_\ell,\mathcal{H}_1,\mathcal{H}_2,\ldots,\mathcal{H}_\ell)$\\
if $i \not\in \mathcal{C} \wedge \Qry_i^{\HashOracle}(M_i,x)=1$ then \\
\nudge Ret 1\\
Ret 0
}
