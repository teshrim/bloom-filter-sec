...
correct against adaptive adversaries.  We note that Neidermayer et
...
\end{theorem}
\begin{proof}
The decompose $\Rep$ into $\Rep_1$ and $\Rep_2$ as follows.  On input
...
\todo{OW privacy proof for classic BF in the ROM}
