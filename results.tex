...
\end{theorem}
\fixme{This result is pretty intuitive following the classic BF correctness result. Probably fine to just explain it and push an appendix, or even drop from camera ready if out of space.}
We note that Kirsch and Mitzenmacher~\cite{kirsch2006less} show
...
bit-length of the longest element $x \in S$. \tsnote{This could be
