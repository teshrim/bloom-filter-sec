...
\caption{Attack for garbled Bloom filters with public~$M$. }
\label{fig:adv-gbf}
\end{figure}
...
\heading{Privacy. }
We observe immediately that when~$\pubaux=\langle M \rangle$ the GBF
cannot be SS-private (in the ROM) because $\privaux=\emptystring$.
