...
\jnote{I guess the most interesting(?)\@ case for comparison purposes
is when $r=1$. Then one can have a scheme, say, where every query is independently
...
under our correctness definition (for $r=1$). So the theorem is tight for $r=1$.}
