...
\tsnote{Seems that correctness and privacy are orthogonal, right?  Even if we restrict to ``compressing'' Rep algorithms (for some appropriate definition of ``compressing'')?  Not sure about relationship between different notions of privacy.}
