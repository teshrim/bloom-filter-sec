...
$\Pi$ is \emph{canonical} if it has a factoring $\Rep_1, \Rep_2, \ell, F$ in which
$F$ is a pseudorandom function (in which case we call $\Rep_1, \Rep_2, \ell, F$ a canonical factoring of~$\Pi$).
...
of canonical, and it is clear that the distributions of everything
