...
\hfill\dqed
\end{definition}
\todo{Words :)  Can compare the (normal) error probability to
  the adversarial soundness probability.  Perhaps pull back some of
  the previous example for building intuition about the difference
  between the two.}
