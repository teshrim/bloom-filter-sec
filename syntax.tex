...
\tsnote{Do we ever use this definition?  I guess it is a mapping of
...
\heading{Data structures for set-membership queries.} An important
special case is a data structure that supports set-membership
...
Note that we do not require ${\cal U} = 2^\univ$ since, e.g., a
