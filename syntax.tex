...
Our syntax also does not capture filters that are mutable, that is, whose representation may change over time.  We address these generalizations next.
...
\tsnote{Not sure how to define correctness, since these kinds of filters/sketches can have two-sided error.}
